...
| 推荐流程 | `Stage1/model/scripts/run_rain_retrieval_workflow.sh` |
...
数据构建逻辑在 `Stage1/model/data/preprocessing.py`。
...
| 输出 | 说明 |
| --- | --- |
| `Stage1/model/data/**/*.npz` | pass 数据集 |
| `Stage1/model/checkpoints*/` | 模型 checkpoint |
